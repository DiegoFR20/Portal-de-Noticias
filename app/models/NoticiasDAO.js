...
NoticiasDAO.prototype.atualizarNoticia = function (id_noticia, noticia, callback) {
    this._connection.query('UPDATE noticias SET titulo = '+noticia.titulo+',resumo = '+noticia.resumo+', autor = '+noticia.autor+',data_noticia = '+noticia.data_noticia+',noticia = '+noticia.noticia+' where id_noticia ='+id_noticia, callback);
}
